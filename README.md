...
## 🌟 주요 기능
- **호주인 페르소나 적용:** 브리즈번 거주, 30대 서퍼 Matt과의 실감 나는 대화 (호주 슬랭 포함)
- **초보자 맞춤형 대화:** 쉬운 단어와 짧은 문장 위주로 대화 (A1-A2 수준)
- **자연스러운 교정:** 대화 중 문법 오류를 자연스럽게 재진술(Rephrasing)하여 학습 지원
- **능동적 상호작용 (선톡):** 1시간 이상 대화가 없을 때, 브리즈번 실시간 날씨 등을 소재로 Matt이 먼저 질문을 던짐
- **데일리 피드백 리포트:** 매일 밤 11시 30분에 오늘 나눈 대화 중 교정이 필요한 표현들을 정리하여 발송
